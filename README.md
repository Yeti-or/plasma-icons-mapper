...
- Search results include `category`, `sizesAvailable`, `svgUrl`, and `previewUrl`
...
- `GET /api/search?name=AttentionCircleFill`
- `GET /api/search?description=icon+inside+circle`
- `GET /api/icons`
- `GET /api/icons/:id`
